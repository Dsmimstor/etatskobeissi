                    ...
                    <thead>
                        <tr>
                            <form method="POST" action="">
                                ...
                                <a href="/stock/entrestockdd.php" name="datebtn" class="fa fa-play fa-2x rotate--270" aria-hidden="true"></a> &nbsp;Date
                                </th>
                                <th scope="col" class="T7" style="width: 110px;">
                                    <a href="/stock/entrestockudf.php" name="datebtn" class="fa fa-play fa-2x rotate--270" aria-hidden="true"></a> &nbsp;N°Facture
                                </th>
                                <th scope="col" class="T7" style="width: 300px;">
                                <a href="/stock/entrestockdda.php" name="datebtn" class="fa fa-play fa-2x rotate--270" aria-hidden="true"></a>&nbsp;Designation
                                </th>
                                ...
                                <a href="/stock/entrestockudo.php" name="datebtn" class="fa fa-play fa-2x rotate--270" aria-hidden="true"></a> &nbsp;Operateur
                                </th>
