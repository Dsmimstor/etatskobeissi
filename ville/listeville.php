    ...
    <script>
        function confirmer(id) {
            if (confirm("Voulez-vous supprimer ce fournisseur?")) {
                location.href = "deleteville.php?id=" + id;
            }
        }
    </script>
</head>
...
<body>
    ...
    <div class="container">
        ...
        <div class="well">
        <h2 class="text-center">LISTE DES VILLES</h2>
            <div style="height:10px;"></div>
            <table width="100%" class="table table-bordered border-primary table-hover" id="tfour">
                <thead>
                    <th scope="col" class="T1">ABREVIATION</th>
                    <th scope="col" class="T2">Ville</th>
                    <th scope="col" class="T3">Pays</th>
                    <th scope="col" class="T8">Actions</th>
                </thead>
                <tbody>
                    <?php
                    $RSql = "SELECT v.*, p.names pays FROM `tvilles` v INNER JOIN `tpays` p ON v.id_pays = p.id ";
                    ...
                    ?>
                        <tr>
                            ...
                            <td style=" font-size:15px ; font-family: sans-serif ; text-align: center">
                                <a type="button" href="updateville.php?id=<?php echo $server["id"]; ?>" class="edit"><i class="fa fa-edit" style="font-size:29px"></i></a>
            ...
            <div class="modal-footer">
                <a href="newsville.php" class="btn btn-primary"><span class="glyphicon glyphicon-remove"></span> Ajouter</a>
