    ...
    <div class="container">
        ...
        <div class="well">
            ...
            <table width="100%" class="table table-bordered border-primary table-hover" id="tfour">
                ...
                <tbody>
                    <?php
                    $RSql = "SELECT f.*, v.names ville, p.names pays FROM `tfournisseurs` f INNER JOIN `tvilles` v ON f.id_ville = v.id INNER JOIN `tpays` p ON v.id_pays = p.id ";
            ...
            <div class="modal-footer">
                <a href="news.php" class="btn btn-primary"><span class="glyphicon glyphicon-remove"></span> Ajouter</a>
