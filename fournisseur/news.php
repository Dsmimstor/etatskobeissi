...
if (!isset($_SESSION["users"])) {
    ...
    if (isset($_POST["btn_update"])) {
        ...
        $RSqls = "INSERT `tfournisseurs`(`code`,`designations`, `email`,`adresse`,`code_zip`,`id_ville`,`compte_contribuable`,`adresse_geographique`,`numero_compte`,`telephone`) VALUES(:code,:designation,:email,:adressepost,:codezip,:formatville,:comptec,:adressegeo,:ncompte,:telephone)";
...
<header class="nav1">
    <!-- Logo-->
    <p class="slogan" href="#">
        <img src="/img/Iconadc.jpg" alt="logoAtelier" />
        <a>ETATS KOBEISSI</a>
    </p>
</header>
...
<body>
    <div class="container">
        ...
        <div class="well">
            ...
            <h2 class="text-center">AJOUTER FOURNISSEUR</h2>
