...
if (!isset($_SESSION["users"])) {
    ...
    if (isset($_POST["btn_update"])) {
        ...
        $RSqls = "UPDATE `tfournisseurs` SET
        ...
        $id = $_GET["id"];
        $RSqls = "SELECT f.*, v.id_pays FROM `tfournisseurs` f INNER JOIN `tvilles` v ON f.id_ville = v.id WHERE f.`id` = '$id' ";
        $query = $conn->prepare($RSqls);
        $query->execute();
...
<body>
    <div class="container">
        ...
        <div class="well">
            ...
            <h2 class="text-center">MODIFER FOURNISSEUR</h2>
