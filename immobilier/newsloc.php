...
if (!isset($_SESSION["users"])) {
    ...
    if (isset($_POST["btn_update"])) {
        ...
        $RSqls = "INSERT `tclients`(`code`,`designations`, `email`,`adresse`,`ncni`,`id_ville`,`typelog`,`telephone`) 
                             VALUES(:code,:designation,:email,:adressepost,:ncni,:formatville,:typelog,:telephone)";
        ...
        $query->bindValue(":ncni", $_POST["ncni"], PDO::PARAM_STR);
        $query->bindValue(":formatville", $_POST["villes"], PDO::PARAM_INT);
        $query->bindValue(":typelog", "GI", PDO::PARAM_STR);
...
<body>
    <div class="container">
        ...
        <div class="well">
            ...
            <h2 class="text-center">CREER LOCATAIRE</h2>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="container-fluid">
                                ...
                                <div class="form-group input-group">
                                    <span class="input-group-addon" style="width:150px;">N°Cni / Passeport :</span>
