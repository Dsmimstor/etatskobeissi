...
if (!isset($_SESSION["users"])) {
    ...
    if (!empty($_POST)) {
        ...
        if (
            ...
            $RSqls = " INSERT INTO `tcategories`(`codecat`, `designationcat`) VALUES (:abreviation,:names)";
...
<head>
    ...
    if ($excecuteIsOk == "succes") {
        echo
        "<script> alert('L\'element a été enregistré'); location.href='listecategorie.php'; </script>";
    }
    if ($excecuteIsOk == "error") {
        "<script> alert('Echec de l\'enregistré de la categorie'); </script>";
    } ?>
                        ...
                        <div class="modal-body">
                            <div class="container-fluid">
                                ...
                                <div class="form-group input-group">
                                    ...
                                    <input type="text" onkeydown="upperCaseFun(this)" style="width:350px; text-align: left;" class="form-control" id="ecodes" name="abreviation">
                                </div>
                                <div class=" form-group input-group">
