    ...
    <script>
        function confirmer(id) {
            if(confirm("Voulez-vous supprimer la Categorie ?")){
                location.href="deletecategorie.php?id="+id;
            }
        }
    </script>
</head>
    ...
    <div class="container">
        ...
        <div class="well">
            ...
            <table width="100%" class="table table-bordered border-primary table-hover" id="tfour">
                ...
                <tbody>
                    <?php
                    $RSql = "SELECT * FROM `tcategories` ORDER BY designationcat";
                        ...
                        <tr>
                            ...
                            <td style="text-align: left; font-size:15px ; font-family: sans-serif ; ">
                                <span class="border border-primary" id="name">
                                    <?= $server["designationcat"] ?>
                                </span>
                            </td>
                             <td style=" font-size:15px ; font-family: sans-serif ; text-align: center">
                                <a type="button" href="updatecategorie.php?id=<?php echo $server["id"]; ?>" class="edit"><i class="fa fa-edit" style="font-size:29px"></i></a>
            ...
            <div class="modal-footer">
                <a href="newscategorie.php" class="btn btn-primary"><span class="glyphicon glyphicon-remove"></span> Ajouter</a>
