	...
	<div class="total">
		<div class="menugene liencache">
			<div class="side-bar">
				...
				<!-- Menu -->
				<div class="menu">
					<div class="item"><a class="sub-btn"><i class="fa-solid fa-user-tie" style="margin-right:13px;"></i>GESTION DES CLIENTS
							<i class="fas fa-angle-right dropdown"></i></a>
						<div class="sub-menu">
							<a href="clients/liste.php" class="sub-item" name="fournisseur" type="submit"><i class="fa-solid fa-user" style='font-size:14px;color:blue'></i>&nbsp
								LISTE DES CLIENTS
							</a>
							<a href="fournisseur/liste.php" class="sub-item" name="fournisseur" type="submit"><i class="fa-solid fa-user-tie" style='font-size:14px;color:red'></i>&nbsp
								LISTE DES FOURNISSEURS
							</a>
						</div>
					</div>
					<div class="item"><a class="sub-btn"><i class="fa-solid fa-people-roof" style="margin-right:13px;"></i>GESTION DES VENTES
							<i class="fas fa-angle-right dropdown"></i>
						</a>
						<div class="sub-menu">
							<div class="item"><a class="sub-btn"><i class="fa-solid fa-people-roof" style="margin-right:13px;"></i>VENTE INTERNE
									<i class="fas fa-angle-right dropdown" style="margin:8px;"></i>
								</a>
								<div class="sub-menu">
									<a href="/venteinterne/listeproforma.php" class="sub-item">&nbsp &nbsp &nbsp<i class='fas fa-cash-register' style='font-size:13px;color:yellow'></i>&nbsp PROFORMA</a>
									<a href="/venteinterne/listebl.php" class="sub-item">&nbsp &nbsp &nbsp<i class='fas fa-cash-register' style='font-size:13px;color:blue'></i>&nbsp BL</a>
									<a href="/venteinterne/listefacture.php" class="sub-item">&nbsp &nbsp &nbsp<i class='fas fa-cash-register' style='font-size:13px;color:white'></i>&nbsp FACTURE</a>
									<a href="/venteinterne/detailventeavoir.php" class="sub-item">&nbsp &nbsp &nbsp<i class='fas fa-cash-register' style='font-size:13px;color:red'></i>&nbsp FACTURE AVOIR</a>
								</div>
							</div>
							<a href="../venteinterne/listevente.php" class="sub-item"><i class='fas fa-cash-register' style='font-size:13px;color:blue'></i>&nbsp VENTE EXTERNE</a>
					...
					<div class="item"><a class="sub-btn"><i class="fa-solid fa-folder-closed" style="margin-right:13px;"></i>GESTION DES STOCKS
							<i class="fas fa-angle-right dropdown"></i>
						</a>
						<div class="sub-menu">
							<a href="" class="sub-item"><i class="fa-solid fa-arrow-trend-up" style="font-size:13px ;color:green"></i>&nbsp ENTREE EN STOCK</a>
							<a href="" class="sub-item"><i class="fa-solid fa-arrow-trend-down" style="font-size:13px ;color:red"></i>&nbsp SORTIE EN STOCK</a>
							<a href="" class="sub-item"><i class="fa-solid fa-arrow-right-arrow-left fa-xs" style="font-size:14px; color:blue;"></i>&nbsp LISTE ENTREE/SORTIE</a>
							<a href="" class="sub-item"><i class="fa-regular fa-folder-open" style="font-size:13px ;color:magenta"></i>&nbsp LISTE DES COMMANDES</a>
						</div>
					</div>
