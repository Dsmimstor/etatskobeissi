                    ...
                    <thead>
                        <tr>
                            <form method="POST" action="">
                                ...
                                <a href="/stocksortie/sortiestockdd.php" name="datebtn" class="fa fa-play fa-2x rotate--270" aria-hidden="true"></a> &nbsp;Date
                                </th>
                                ...
                                <a href="/stocksortie/sortiestockdda.php" name="datebtn" class="fa fa-play fa-2x rotate--270" aria-hidden="true"></a>&nbsp;Designation
                                </th>
