                        ...
                        <tr>
                            <form method="POST" action="">
                                ...
                                <th scope="col" class="T7" style="width: 110px;">
                                    <a href="/stocksortie/sortiestockucf.php" name="datebtn" class="fa fa-play fa-2x rotate--270" aria-hidden="true"></a> &nbsp;N°Facture
                                </th>
                                <th scope="col" class="T7" style="width: 300px;">
                                <a href="/stocksortie/sortiestockuda.php" name="datebtn" class="fa fa-play fa-2x rotate--270" aria-hidden="true"></a>&nbsp;Designation
                                </th>
                                ...
                                <a href="/stocksortie/soriestockudo.php" name="datebtn" class="fa fa-play fa-2x rotate--270" aria-hidden="true"></a> &nbsp;Operateur
                                </th>
