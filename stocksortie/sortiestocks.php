                    ...
                    <thead>
                        <tr>
                            <th scope="col" class="T2" style="width: 90px;">
                                <i class="fa fa-play fa-2x rotate-0" aria-hidden="true"></i> &nbsp;Date
                            </th>
                            <th scope="col" class="T7" style="width: 110px;">
                                <i class="fa fa-play fa-2x rotate-0" aria-hidden="true"></i> &nbsp;N°Facture
                            </th>
                            <th scope="col" class="T7" style="width: 300px;">
                                <i class="fa fa-play fa-2x rotate-0" aria-hidden="true"></i> &nbsp;Designation
                            </th>
                            <th scope="col" class="T4" style="width: 90px;">Quantité</th>
                            <th scope="col" class="T4" style="width: 90px;">
                                <i class="fa fa-play fa-2x rotate-0" aria-hidden="true"></i> &nbsp;Mvemt
                            </th>
                            <th scope="col" class="T4" style="width: 200px;">
                                <i class="fa fa-play fa-2x rotate-0" aria-hidden="true"></i> &nbsp;Operateur
                            </th>
                        ...
                        <div class="modal-content" style="width: 700px;">
                            ...
                            <form id="modalForm1" method="POST">
                                ...
                                <div class="form-group input-group">
                                    ...
                                    <input type="text" style="width:450px;" class="form-control" id="id1" name="id1">
                                </div>
                                <div class="form-group input-group">
                                    <span class="input-group-addon" style="width:170px;">N° Facture:</span>
                        ...
                        <ul class="pagination">
                            ...
                            <?php for ($i = 1; $i <= $pages; $i++) : ?>
                                <li class="page-item <?= ($currentPage == $i) ? "active" : "" ?>">
                                    <a href="/stock/sortiestocks.php?page=<?= $i ?>&typefactures=<?= $typefactures ?>&from_date=<?= $from_date ?>&to_date=<?= $to_date ?>" class="page-link"><?= $i ?></a>
                                </li>
                            <?php endfor ?>
                            <li class="page-item <?= ($currentPage == $pages) ? "disabled" : "" ?>">
                                <a href="/stock/sortiestocks.php?page=<?= $currentPage + 1 ?>&typefactures=<?= $typefactures ?>&from_date=<?= $from_date ?>&to_date=<?= $to_date ?>" class="page-link">Suivante</a>
                            </li>
                        </ul>
                    </nav>
                    <div class="modal-footer">
