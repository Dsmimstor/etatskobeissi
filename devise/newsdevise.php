...
if (!isset($_SESSION["users"])) {
    ...
    if (!empty($_POST)) {
        ...
        if (
            ...
            $RSqls = " INSERT INTO `tdevise`(`abreviation`, `names`) VALUES (:abreviation,:names)";
...
<head>
    ...
    if ($excecuteIsOk == "succes"){
        echo
        "<script> alert('L\'element a été enregistré'); location.href='listedevise.php'; </script>";
    }
    if ($excecuteIsOk == "error"){
        "<script> alert('Echec de l\'enregistré la devise'); </script>";
    } ?>
