...
<head>
    ...
    <script>
        function confirmer(id) {
            if(confirm("Voulez-vous supprimer la devise ?")){
                location.href="deletedevise.php?id="+id;
            }
        }
    </script>
</head>
    ...
    <div class="container">
        ...
        <div class="well">
            ...
            <table width="100%" class="table table-bordered border-primary table-hover" id="tfour">
                ...
                <tbody>
                    <?php
                    $RSql = "SELECT * FROM `tdevise` ORDER BY names";
                        ...
                        <tr>
                            ...
                            <td style="text-align: left; font-size:15px ; font-family: sans-serif ; ">
                             ...
                             <td style=" font-size:15px ; font-family: sans-serif ; text-align: center">
                                <a type="button" href="updatedevise.php?id=<?php echo $server["id"]; ?>" class="edit"><i class="fa fa-edit" style="font-size:29px"></i></a>
            ...
            <div class="modal-footer">
                <a href="newsdevise.php" class="btn btn-primary"><span class="glyphicon glyphicon-remove"></span> Ajouter</a>
