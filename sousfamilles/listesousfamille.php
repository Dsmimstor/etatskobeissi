    ...
    <script>
        function confirmer(id) {
            if (confirm("Voulez-vous supprimer cet element ?")) {
                location.href = "deletesousfamille.php?id=" + id;
            }
        }
    </script>
</head>
...
<body>
    ...
    <div class="container">
        ...
        <div class="well">
        <h2 class="text-center">LISTE DES SOUS FAMILLES</h2>
            <div style="height:10px;"></div>
            <table width="100%" class="table table-bordered border-primary table-hover" id="tfour">
                <thead>
                    <th scope="col" class="T1">Code</th>
                    <th scope="col" class="T2">Sous Famille</th>
                    <th scope="col" class="T3">Famille</th>
                    <th scope="col" class="T8">Actions</th>
                </thead>
                <tbody>
                    <?php
                    $RSql = "SELECT sf.*, f.designationfam fam FROM `tsousfamilles` sf INNER JOIN `tfamilles` f ON sf.id_fam = f.id ";
                    ...
                    ?>
                        <tr>
                            ...
                            <td style=" font-size:15px ; font-family: sans-serif ; text-align: center">
                                <a type="button" href="updatesousfamille.php?id=<?php echo $server["id"]; ?>" class="edit"><i class="fa fa-edit" style="font-size:29px"></i></a>
            ...
            <div class="modal-footer">
                <a href="newssousfamille.php" class="btn btn-primary"><span class="glyphicon glyphicon-remove"></span> Ajouter</a>
