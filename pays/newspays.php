...
if (!isset($_SESSION["users"])) {
    ...
    if (!empty($_POST)) {
        ...
        if (
            ...
            $RSqls = " INSERT INTO `tpays`(`abreviation`, `names`) VALUES (:abreviation,:names)";
...
<head>
    ...
    if ($excecuteIsOk == "succes"){
        echo
        "<script> alert('L\'element a été enregistré'); location.href='listepays.php'; </script>";
    }
                        ...
                        <div class="modal-body">
                            <div class="container-fluid">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <a href="listepays.php" class="btn btn-default"><span class="glyphicon glyphicon-remove"></span> Annuller</a>
                                </div>
                            </div>
                        </div>
