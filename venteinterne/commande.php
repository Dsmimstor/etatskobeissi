...
<body>
    ...
    <div class="container">
                ...
                <div class="d-flex align-self-stretch" style="height:165px; display: flex;">
                    ...
                    <div class="p-4 flex-fill dv" style=" padding: 2px;">
                        <div class=" form-group1 input-group" style=" padding: 1px;">
                            ...
                            <span class="input-group-addon" style="width:200px;  text-align: center; background-color:white;" id="totaltva" name="totaltva">Client :</span>
                        </div>
                        <div class=" form-group1 input-group" style=" padding: 1px;">
                            <span class="input-group-addon" style="width:105px; text-align: left;"> TVA :</span>
                            <span class="input-group-addon" style="width:200px;  text-align: center;; background-color:white;" id="totalht" name="totalht">Client :</span>
                        </div>
                        <div class=" form-group1 input-group" style=" padding: 1px;">
        ...
        <div class="modal-footer">
            <a href="news.php" class="btn btn-primary"><span class="glyphicon glyphicon-plus"></span> Enregistrer</a>
