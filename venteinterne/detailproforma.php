...
<head>
    ...
    <script>
        function valider(id) {
            ...
            const datefacture = document.getElementById('datecmd').value;
            ...
            const nfacture = document.getElementById('commande').value;
            ...
            if (confirm("Voulez-vous vusialiser la Facture ?")) {
                ...
                const url = `reportpdfpro.php?id=${encodeURIComponent(id)}
                    ...
                    <div class="p-4 flex-fill dv" style=" padding: 1px; ">
                        <div class="p-4 flex-fill dv" style=" padding: 1px; ">
                            <div class=" form-group1 input-group" style=" padding: 1px;">
                                ...
                                <input type="text" readonly onkeydown="upperCaseFun(this)" style="width:160px; text-align: left;" id="commande" name="commande" required value="<?php echo $resultcmd["numeros"]; ?>">
                            </div>
                            <div class=" form-group1 input-group" style=" padding: 1px;">
                                <span class="input-group-addon" style="width:122px; text-align: left;">Date Pro :</span>
                                <input type="date" readonly style="width:160px; " id="datecmd" name="datecmd" required value="<?php echo $resultcmd["dates"]; ?>">
                            </div>
                        </div>
