...
<head>
    ...
    <script>
        function valider(id) {
            const tht = document.getElementById('totalht').value;
            const frais = document.getElementById('frais').value;
            const transport = document.getElementById('transport').value;
            const datecmd = document.getElementById('datecmd').value;

            if (confirm("Voulez-vous Basculer en Bon de Livraison ?")) {
                // Construire l'URL avec les paramètres de requête
                const url = `validercmd.php?id=${id}&tht=${tht}&frais=${frais}&transport=${transport}`;
    ...
    <div class="container">
        ...
        <div class="well">
            <div class="dv1" style="text-align:center; margin:10px; box-shadow: 2px -1px 3px ;">
                <h2 style="text-shadow: 1px 1px 2px brown, 0 0 1em brown, 0 0 0.2em brown;"> DETAIL COMMANDE </h2>
            </div>
                ...
                <div class="d-flex align-self-stretch" style="height:185px; display: flex;">
                    <div class="p-4 flex-fill dv" style=" padding: 1px; ">
                        ...
                        <div class=" form-group1 input-group" style=" padding: 1px;">
                            ...
                            <input type="text" readonly onkeydown="upperCaseFun(this)" style="width:160px; text-align: left;" id="proforma" name="proforma" required value="<?php echo $resultcmd["ncommande"]; ?>">
                        </div>
                        <div class=" form-group1 input-group" style=" padding: 1px;">
                    ...
                    <div class="p-4 flex-fill dv" style=" padding: 2px;">
                        <div class=" form-group1 input-group" style=" padding: 1px;">
                            ...
                            <input type="text" readonly onkeydown="upperCaseFun(this)" style="width:410px; " id="client" name="client" required value="<?php echo $resultcmd["designations"]; ?>">
                        </div>
                        <div class=" form-group1 input-group" style=" padding: 1px;">
                            <span class="input-group-addon" style="width:85px; text-align: left;">Adresse :</span>
                            <input type="text" readonly onkeydown="upperCaseFun(this)" style="width:410px; " id="adresse" name="adresse" required value="<?php echo $resultcmd["adresse"]; ?>">
                        </div>
                        <div class=" form-group1 input-group" style=" padding: 1px;">
                            <span class="input-group-addon" style="width:85px; text-align: left;">Tel :</span>
                            <input type="text" readonly onkeydown="upperCaseFun(this)" style="width:410px;" id="telephone" name="telephone" required value="<?php echo $resultcmd["telephone"]; ?>">
                        </div>
                        <div class=" form-group1 input-group" style=" padding: 1px;">
                            <span class="input-group-addon" style="width:85px; text-align: left;">Email :</span>
                            <input type="email" onkeydown="upperCaseFun(this)" readonly style="width:410px;" id="email" name="email" required value="<?php echo $resultcmd["email"]; ?>">
                        </div>
                        <div class=" form-group1 input-group" style=" padding: 1px;">
                            <span class="input-group-addon" style="width:85px; text-align: left;">Adr Geo :</span>
                            <textarea name="commentaire" cols="30" rows="3" readonly style="width:410px; " required value="<?php echo $resultcmd["adrgeographique"]; ?>"></textarea>
                        </div>
                    </div>
        ...
        <div class="modal-footer">
            <a type="button" onclick="imprimer(<?php echo $idc; ?>)" class="btn btn-info"">Imprimer Commande</a>
            <a type="button" onclick="valider(<?php echo $idc; ?>)" class="btn btn-success">Basculer en BL</a>
