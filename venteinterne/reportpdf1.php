...
<body>
    <div class="invoice-header">
        <p class="logo" style=" display: flex; margin: 0;">
            <img src="' . $src . '" alt="Logo" style=" margin: 0;">
    ...
    <div class="content">
        ...
        <table>
            <thead>
                <tr>
                    <td colspan="2" style="text-align: left; border-bottom: none;border-right: none;font-size: 15px;">Client :</td>
                    <td style="text-align: left;border-bottom: none; border-left: none;font-size: 15px;">Teléphone : </td>
                </tr>
                <tr>
                    <td colspan="2"  style="text-align: left;border-top: none; border-right: none;font-size: 15px; ">Email : dsmistor01@gmail.com</td>
                    <td style="text-align: left;border-top: none;border-left: none;font-size: 15px;">Adresse :</td>
                </tr>
            </thead>
        </table>
...
$html .= '
                <tr class="total">
                    <td colspan="4" style="text-align: right; border-bottom: none;">Total HT : </td>
