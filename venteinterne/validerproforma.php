...
if (!isset($_SESSION["users"])) {
    ...
    if ($id === false || $tht === false || $frais === false || $transport === false || $datecmd === false) {
        die("Entrée invalide");
    }
    ...
    try {
        ...
        // Lier les paramètres
        $query->bindValue(":dates", $datecmd, PDO::PARAM_STR);
        $query->bindValue(":ncommande", $ncommande, PDO::PARAM_STR);
        $query->bindValue(":typecmd", "CD", PDO::PARAM_STR);
