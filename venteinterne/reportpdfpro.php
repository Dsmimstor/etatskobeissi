...
foreach ($servers as $server) {
    $html .= '
                <tr style="font-size: 15px;">
                    ...
                    <td style="border-bottom: none; border-top: none;">' . number_format($server["prix"], 2, ',', ' ') . '</td>
                    ...
                    <td style="border-bottom: none; border-top: none;">' . number_format($server["prix"] * $server["quantite"], 2, ',', ' ') . '</td>
                </tr>';
    $total += $server["prix"] * $server["quantite"];
}
$html .= '
                <tr class="total">
                    <td colspan="4" style="text-align: right; border-bottom: none;border-left: none;">Total HT : </td>
                    <td>' . number_format($total, 2, ',', ' ') . '</td>
                </tr>
                <tr class="total">
                    <td colspan="4"style="text-align: right; border-top: none; border-bottom: none; border-left: none;">Frais de gestion % : </td>
                    <td>' . number_format($frais, 2, ',', ' ') . '</td>
                </tr>
                <tr class="total">
                    <td colspan="4"style="text-align: right;  border-top: none; border-bottom: none;border-left: none;">Transport € : </td>
                    <td>' . number_format($transport, 2, ',', ' ') . '</td>
                </tr>
                <tr class="total">
                    <td colspan="4" style="text-align: right;  border-top: none; border-bottom: none;border-left: none;">Montant Total € : </td>
                    <td>' . number_format((($total * $frais / 100) + $total + $transport), 2, ',', ' ') . '</td>
                </tr>
                <tr class="total">
                    <td colspan="4" style="text-align: right;  border-bottom: none; border-top: none;border-left: none;">Montant Total FCFA : </td>
