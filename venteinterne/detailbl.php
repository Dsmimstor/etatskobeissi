...
<head>
    ...
    <script>
        function valider(id) {
            ...
            if (confirm("Voulez-vous Basculer en Facture ?")) {
                // Construire l'URL avec les paramètres de requête encodés
                const url = `validerbl.php?id=${encodeURIComponent(id)}&tht=${encodeURIComponent(tht)}&frais=${encodeURIComponent(frais)}&transport=${encodeURIComponent(transport)}&datefacture=${encodeURIComponent(datefacture)}`;
...
<body>
    ...
    <div class="container">
        ...
        <div class="modal-footer">
            <a type="button" onclick="valider(<?php echo $idc; ?>)" class="btn btn-success">Valider en Facture</a>
