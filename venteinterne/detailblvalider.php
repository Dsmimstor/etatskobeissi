    ...
    <script>
        function valider(id) {
         ...
         //   const tauxechange = parseFloat(document.getElementById('tauxechange').value);
            ...
            const datefacture = document.getElementById('datebl').value;
            const nfacture = document.getElementById('nbonliv').value;
            ...
            if (confirm("Voulez-vous vusialiser la Facture ?")) {
                ...
                const url = `reportpdfbl.php?id=${encodeURIComponent(id)}
    ...
    <div class="container">
        ...
        <div class="well">
            <div class="dv1" style="text-align:center; margin:10px; box-shadow: 2px -1px 3px ;">
                <h2 style="text-shadow: 1px 1px 2px brown, 0 0 1em brown, 0 0 0.2em brown;"> DETAIL BON DE LIVRAISON </h2>
            </div>
                    ...
                    <div class="p-4 flex-fill dv" style=" padding: 1px; ">
                        <div class="p-4 flex-fill dv" style=" padding: 1px; ">
                            ...
                            <div class=" form-group1 input-group" style=" padding: 1px;">
                                ...
                                <input type="date" style="width:160px; " id="datefacture" name="datefacture" required value="<?php echo date('Y-m-d'); ?>">
                            </div>
                        </div>
        ...
        <a type="button" onclick="valider(<?php echo $idc; ?>)" class="btn btn-warning">Inmprimer Bon Livraison</a>
