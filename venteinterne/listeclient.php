    ...
    <div class="container">
        ...
        <div class="well">
            ...
            <table width="100%" class="table table-bordered border-primary table-hover" id="tfour">
                ...
                <tbody>
                    <?php
                    $RSql = "SELECT f.*, v.names ville, p.names pays FROM `tclients` f INNER JOIN `tvilles` v ON f.id_ville = v.id INNER JOIN `tpays` p ON v.id_pays = p.id ";
                    ...
                    ?>
                        <tr>
                            ...
                            <td style=" font-size:15px ; font-family: sans-serif ; text-align: center">
                         <!--       <a type="button" href="/venteinterne/commandes.php?id=<?php echo $server["id"]; ?>" class="edit"><i class="fa fa-edit" style="font-size:29px"></i></a>-->
                             </td>
                        </tr>
                    <?php
                    }
            ...
            <div class="modal-footer">
                <a href="../venteinterne/clientnews.php.php" class="btn btn-primary"><span class="glyphicon glyphicon-remove"></span> Ajouter</a>
                <a href="/venteinterne/commandes.php" class="btn btn-default"><span class="glyphicon glyphicon-remove"></span> Quitter</a>
            </div>
        </div>
