...
<head>
    ...
    if ($excecuteIsOk == "succes") {
        echo "<script> alert('L\'element a été modifié'); location.href='listeclient.php'; </script>";
    }
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <a href="../venteinterne/listeclient.php" class="btn btn-default"><span class="glyphicon glyphicon-remove"></span> Annuler</a>
                        </div>
                    </div>
                </div>
