...
<head>
    ...
    <script>
        function valider(id) {
            ...
            const datebl = document.getElementById('datebl').value;
            const frais = parseFloat(document.getElementById('frais').value);
            const transport = parseFloat(document.getElementById('transport').value);
            if (confirm("Voulez-vous Basculer en Bon Livraison ?")) {
                // Construire l'URL avec les paramètres de requête encodés
                const url = `validercommande.php?id=${encodeURIComponent(id)}&tht=${encodeURIComponent(tht)}&frais=${encodeURIComponent(frais)}&transport=${encodeURIComponent(transport)}&datebl=${encodeURIComponent(datebl)}`;
    ...
    <div class="container">
        ...
        <div class="well">
            <div class="dv1" style="text-align:center; margin:10px; box-shadow: 2px -1px 3px ;">
                <h2 style="text-shadow: 1px 1px 2px brown, 0 0 1em brown, 0 0 0.2em brown;"> DETAIL COMMANDES </h2>
            </div>
        ...
        <div class="modal-footer">
            ...
            <a type="button" onclick="valider(<?php echo $idc; ?>)" class="btn btn-success">Valider en Bon Liv</a>
