                        ...
                        <tr>
                            <form method="POST" action="">
                                ...
                                <th scope="col" class="T7" style="width: 110px;">
                                    <a href="/stockentree/entrestockudf.php" name="datebtn" class="fa fa-play fa-2x rotate-388" aria-hidden="true"></a> &nbsp;N°Facture
                                </th>
                                <th scope="col" class="T7" style="width: 300px;">
                                    <a href="/stockentree/entrestock.php" name="datebtn" class="fa fa-play fa-2x rotate--270" aria-hidden="true"></a>&nbsp;Designation
                                </th>
                                ...
                                <th scope="col" class="T4" style="width: 200px;">
                                    <a href="/stockentree/entrestock.php" name="datebtn" class="fa fa-play fa-2x rotate--270" aria-hidden="true"></a> &nbsp;Operateur
                                </th>
