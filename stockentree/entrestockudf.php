...
if (!isset($_SESSION["users"])) {
    ...
    $RSqlfacture = "SELECT d.*, c.* FROM `tdocuments` d INNER JOIN `tdetail_document` c ON d.id = c.id_document WHERE d.`typesfacture` = '$idc' ORDER BY nfacture ASC";
                    ...
                    <thead>
                        <tr>
                            <form method="POST" action="">
                                ...
                                <a href="/stockentree/entrestockud.php" name="datebtn" class="fa fa-play fa-2x rotate--270" aria-hidden="true"></a> &nbsp;Date
                                </th>
                                <th scope="col" class="T7" style="width: 110px;">
                                    <a href="/stockentree/entrestockucf.php" name="datebtn" class="fa fa-play fa-2x rotate--270" aria-hidden="true"></a> &nbsp;N°Facture
                                </th>
                                <th scope="col" class="T7" style="width: 300px;">
                                <a href="/stockentree/entrestockuda.php" name="datebtn" class="fa fa-play fa-2x rotate--270" aria-hidden="true"></a>&nbsp;Designation
                                </th>
            ...
            <script>
                ...
                $(document).ready(function() {
                    $('.factureBtns').on('click', function() {
                        ...
                        var nfacture = currentRow.find('td:eq(0)').text();
                        var designation = currentRow.find('td:eq(1)').text();
